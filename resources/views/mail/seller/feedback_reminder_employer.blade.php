                    ...
                    <td bgcolor="#FFFFFF">
                        <table width="540" border="0" cellspacing="0" cellpadding="0" align="center" class="agile1 scale">
                            ...
                            <tr>
                                ...
                                Hello {{$jobDetail->employer_name}},<br>
                                <ui>You missed feedback for <b>{{$jobDetail->job_title}}</b></ui><br>
                            </td>
                            <tr>
                                <td height="25" style="font-size: 1px;">&nbsp;</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                Employer Panel : <a href="{{$url}}">Click Here</a>
                                </td>
                            </tr>
