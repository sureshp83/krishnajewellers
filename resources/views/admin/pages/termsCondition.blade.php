                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        @include('admin.common.flash')
                            <form class="form" name="TermsConditionUpdate" id="TermsConditionUpdate" method="post" enctype="multipart/form-data" action="{{ route('pages.terms-condition.update') }}">
                        {{ csrf_field() }}
                        <div class="form-group">
                            
                                <textarea class="ckeditor" name="content" id="content" placeholder="Enter Terms & conditions">
                                    @if(isset($termsCondition->content))
                                    {{  $termsCondition->content }}
                                    @endif
                                </textarea>
                                <label id="content-error" class="error" for="content" style="display: none;">Please enter terms & conditions</label>    
                        </div>
